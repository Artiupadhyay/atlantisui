...
function HomeworkCard(props) {
    ...
    return(
        <div className="mt-5 card  ml-3 shadow mr-auto" style={{width: "30rem"}}>
            {(props.homeworkinfo.image !=='/media/null' && props.homeworkinfo.image) ? <img className="card-img-top"  src={"data:image/jpeg;base64,"+props.homeworkinfo.image}  alt="Card" /> :null}
